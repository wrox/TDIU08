...
procedure calculator is   
   ...
   -- Operatorer
   function "+"(fX: in Float; iA: in Integer) return Float is
      fY: Float;
   begin
      fY := Float(iA);
      return fX + fY;
   ...
   function "+"(iA: in Integer; fX: in Float) return Float is
      fY: Float;
   begin
      -- return fX + iA;
      fY := Float(iA);
